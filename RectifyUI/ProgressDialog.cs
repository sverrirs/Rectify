...
namespace RectifyUI
{
    ...
    /// From: http://www.brad-smith.info/blog/archives/523
    /// </summary>
    public class ProgressDialog : IDisposable
    {
        ...
        // Timer that handles polling the window state (e.g. closebutton state)
        private System.Threading.Timer _statePollingTimer;
        private Form _parentForm;

        /// <summary>
        /// Raised when the user clicks the "Cancel" button to terminate the operation
        /// </summary>
        ...
        private void _statePollingTimerCallback(object state)
        {
            if (_nativeProgressDialog == null ||
                _state == ProgressDialogState.Stopped ||
                _parentForm == null )
